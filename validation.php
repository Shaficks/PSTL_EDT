...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="fr">
    ...
    <div class="jumbotron">
      <div class="container">         
        ...
        <div id="contextInfos">
            <span id="contextinfo"><b><?php echo "Le " . date("d.m.y") . " &agrave; " . date("H:i:s"); ?></b></span><br/>
...
// Script servant à envoyer le mail à l'etudiant en mettant comme emetteur le secretariat de sa specialite
// Ensuite il envoi le même mail une 2ème fois mais cette fois de l'etudiant à l'admin et au secretariat
