function print_edts(listeEDT, classe) {
    ...
    printSupHTML("#edts", "<br/><span class=\"nbedt\" id=\"nbedt_" + classe + "\">Il y a " + listeEDT.length + " emplois du temps de classe " + classe + " </span>");
...
//alert(JSON.stringify(asso));
    ...
    printSupHTML("#edtbox_" + classe + "_" + num, "<table id=\"edttab_" + classe + "_" + num + "\" class=\"edttab\"></table>");
