            ...
            <tr>
                ...
                <td>
                    <p>
                        ...
                        Suivant les UE que vous avez d&eacute;j&agrave; valid&eacute;es, il vous reste &agrave; choisir un certain nombre d'UE.
                        Veuillez cocher celles qui vous int&eacute;ressent. Au final, vous
                        devez valider 5 UE (en comptant celles que vous avez d&eacute;j&agrave; acquises).

                        Dans la liste ci-dessous, les UE obligatoires apparaissent avec l'information <font color='red'>(oblig.)</font>).
...
<td width="10%"> </td>
<td width="180"> <input type="checkbox" name="lrc" id="lrc"><label for="lrc">LRC <font color='red'>(oblig.)</font></label> </td>
</tr>
<tr>
...
<td width="10%"> </td>
<td width="180"> <input type="checkbox" name="mogpl" id="mogpl"/><label for="mogpl">MOGPL <font color='red'>(oblig.)</font></label></td>
</tr>
</table>
...
<td width="10%"> </td>
<td width="180"> <input type="checkbox" name="mlbda" id="mlbda"/><label for="mlbda">MLBDA <font color='red'>(oblig.)</font></label></td>
</tr>
<tr>
...
<table>
<tr>
<td width="180"> <input type="checkbox" name="aagb" id="aagb"/><label for="aagb">AAGB <font color='red'>(oblig.)</font></label> </td>
<td width="10%"> </td>
<td width="180"> <input type="checkbox" name="4m062" id="4m062"/><label for="4m062">4M062 <font color='red'>(oblig.)</font></label></td>
</tr>
<tr>
<td width="180"> <input type="checkbox" name="mapsi" id="mapsi"/><label for="mapsi">MAPSI  <font color='red'>(oblig.)</font></label></td>
<td width="10%"> </td>
    ...
    <script>
        ...
        function verif(num, spe) {
            ...
            for (i = 0; i < liste.length; i++) {
                ...
                if (cpt > 5) {
                    alert('Il y a ' + cpt + ' UE choisies. Il ne peut pas y en avoir plus de 5.');
                } else {
